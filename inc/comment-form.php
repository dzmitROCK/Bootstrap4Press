...
if ( ! function_exists( 'bootstrap4press_comment_form_fields' ) ) {
	function bootstrap4press_comment_form_fields( $fields ) {
		...
		$fields    = array(
			'author'  => '<div class="form-group comment-form-author"><label for="author">' . __( 'Your name',
			...
			'email'   => '<div class="form-group comment-form-email"><label for="email">' . __( 'Your email',
					'bootstrap4press' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
			...
			'url'     => '<div class="form-group comment-form-url"><label for="url">' . __( 'Your website',
